...
//Removal of other stoof
    //Botania
        ...
        e.remove({output: 'botania:lens_speed'});
        e.remove({output: 'botania:lens_power'});
        e.remove({output: 'botania:lens_time'});
        e.remove({output: 'botania:lens_efficiency'});
        e.remove({output: 'botania:lens_gravity'});
        e.remove({output: 'botania:lens_mine'});
        e.remove({output: 'botania:lens_damage'});
        e.remove({output: 'botania:lens_phantom'});
        e.remove({output: 'botania:lens_magnet'});
        e.remove({output: 'botania:lens_explosive'});
        e.remove({output: 'botania:lens_influence'});
        e.remove({output: 'botania:lens_weight'});
        e.remove({output: 'botania:lens_paint'});
        e.remove({output: 'botania:lens_fire'});
        e.remove({output: 'botania:lens_piston'});
        e.remove({output: 'botania:lens_light'});
        e.remove({output: 'botania:lens_warp'});
        e.remove({output: 'botania:lens_redirect'});
        e.remove({output: 'botania:lens_firework'});
    ...
    //Immersive Engineering
        ...
        e.remove({output: 'immersiveengineering:windmill_blade'});
        ...
        e.remove({output: 'immersiveengineering:wire_copper'});
        e.remove({output: 'immersiveengineering:wire_electrum'});
        e.remove({output: 'immersiveengineering:wire_aluminum'});
        e.remove({output: 'immersiveengineering:wire_steel'});
        e.remove({output: 'immersiveengineering:wire_lead'});
        e.remove({output: 'immersiveengineering:light_bulb'});
        e.remove({output: 'immersiveengineering:electron_tube'});
        ...
        e.remove({output: 'immersiveengineering:skyhook'});
        e.remove({output: 'immersiveengineering:earmuffs'});
        ...
        e.remove({output: 'immersiveengineering:wirecoil_copper'});
        e.remove({output: 'immersiveengineering:wirecoil_electrum'});
        e.remove({output: 'immersiveengineering:wirecoil_steel'});
        e.remove({output: 'immersiveengineering:wirecoil_structure_rope'});
        e.remove({output: 'immersiveengineering:wirecoil_structure_steel'});
        e.remove({output: 'immersiveengineering:wirecoil_redstone'});
        e.remove({output: 'immersiveengineering:wirecoil_copper_ins'});
        e.remove({output: 'immersiveengineering:wirecoil_electrum_ins'});
        ...
        e.remove({output: 'immersiveengineering:circuit_table'});
        e.remove({output: 'immersiveengineering:gunpowder_barrel'});
        e.remove({output: 'immersiveengineering:crate'});
        e.remove({output: 'immersiveengineering:reinforced_crate'});
        ...
        e.remove({output: 'immersiveengineering:windmill'});
        e.remove({output: 'immersiveengineering:watermill'});
        ...
        e.remove({output: 'immersiveengineering:connector_lv'});
        e.remove({output: 'immersiveengineering:connector_mv'});
        e.remove({output: 'immersiveengineering:connector_hv'});
        e.remove({output: 'immersiveengineering:connector_lv_relay'});
        e.remove({output: 'immersiveengineering:connector_mv_relay'});
        e.remove({output: 'immersiveengineering:connector_hv_relay'});
    ...
    //PneumaticCraft
        ...
        e.remove({output: 'pneumaticcraft:heat_sink'});
