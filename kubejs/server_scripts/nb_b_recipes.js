...
//------------------------------------------------------------------
    ...
    //Shapeless Crafting
        //Crude Abrasive
            e.shapeless('4x nyagibits_bytes:crude_abrasive',['minecraft:sand', 'minecraft:gravel']) 
        //Pile Of Cogs
            e.shapeless('nyagibits_bytes:pile_of_cogs',['create:large_cogwheel', '3x create:cogwheel'])
        //Bucket of Salt Water
            e.shapeless('nyagibits_bytes:bucket_of_salt_water',['mekanism:salt', 'minecraft:water_bucket'])
        //Pen Assembly
            e.shapeless('nyagibits_bytes:pen_assembly',['nyagibits_bytes:ball_bearing', 'nyagibits_bytes:thin_casing', 'nyagibits_bytes:tiny_spring', 'nyagibits_bytes:ink_cartridge'])
        //Lab Notebook
            e.shapeless('nyagibits_bytes:lab_notebook',['nyagibits_bytes:pen', 'minecraft:book'])
//------------------------------------------------------------------
    //Botania Crafting
        //Pure Daisy
            //Livisite
        ...
        //Apothecary
            //Used Crude Natural Arcana Test
                e.recipes.botania.petal_apothecary("nyagibits_bytes:used_crude_natural_arcana_test", ['nyagibits_bytes:crude_natural_arcana_test','minecraft:pumpkin_seeds','minecraft:hay_block','farmersdelight:tomato_seeds'])
//------------------------------------------------------------------
    //Create Crafting
        //Sandpaper Polishing
            //Polished Living Rock
                e.recipes.createSandpaperPolishing('nyagibits_bytes:polished_livisite',['nyagibits_bytes:livisite_stone'])
        //Compacting
            //Pile of Crude Mechanical Parts
                e.recipes.create.compacting(['nyagibits_bytes:pile_of_crude_mechanical_parts'], ['create:wrench', 'create:electron_tube', 'create:gantry_shaft', 'create:brass_hand', 'nyagibits_bytes:pile_of_cogs', 'create:hand_crank', 'create:andesite_casing', 'create:brass_sheet'])
            //Used Crude Compression Test
                e.recipes.create.compacting(['nyagibits_bytes:used_crude_compression_test'], ['nyagibits_bytes:crude_compression_test'])
            //Micro Tools
                e.recipes.create.compacting(['nyagibits_bytes:micro_tools'], ['create:andesite_casing', 'ae2:certus_quartz_wrench', 'ae2:nether_quartz_wrench', 'ae2:crank', Item.of('ae2:nether_quartz_cutting_knife', '{Damage:0}'), Item.of('ae2:certus_quartz_cutting_knife', '{Damage:0}')])
            //Basic Composite Material
                e.recipes.create.compacting(['nyagibits_bytes:basic_composite_material'], ['create:copper_sheet','create:iron_sheet','nyagibits_bytes:livisite_slate','minecraft:brick','minecraft:coal','ae2:certus_quartz_dust'])
            //Empty Schematic
                e.recipes.create.compacting(['nyagibits_bytes:blank_blueprint'], ['minecraft:paper', 'minecraft:paper', 'minecraft:paper', 'minecraft:paper', 'minecraft:paper', 'minecraft:paper', 'minecraft:paper', 'minecraft:paper'])
        //Mixing
            //Soild Sample
                e.recipes.create.mixing('4x nyagibits_bytes:soil_sample',['minecraft:coarse_dirt', 'minecraft:sand', 'minecraft:clay', 'minecraft:mud'])
            //Used Crude Entropy Test
                e.recipes.create.mixing('nyagibits_bytes:used_crude_entropy_test',['nyagibits_bytes:crude_entropy_test']).heated()
            //Ink
                e.recipes.create.mixing('2x nyagibits_bytes:ink',['minecraft:ink_sac', Fluid.of('water', 1000)]).heated()
            //Crude Silicon Boule
            ...
            //Bottle of Anthocyanin
                e.recipes.create.mixing('nyagibits_bytes:bottle_of_anthocyanin',[Fluid.of('water', 250), 'farmersdelight:cabbage', 'minecraft:glass_bottle']).heated()
            //Bottle of Malic & Citric Acid
                e.recipes.create.mixing('nyagibits_bytes:bottle_of_malic_and_citric_acid',[Fluid.of('water', 250), 'farmersdelight:tomato', 'minecraft:glass_bottle']).heated()
            //Soild Sample
                e.recipes.create.mixing('nyagibits_bytes:used_crude_acidics_test',['nyagibits_bytes:crude_acidics_test'])
        //Milling
            //Ball Bearing
                e.recipes.create.milling('8x nyagibits_bytes:ball_bearing',['minecraft:iron_nugget'])
        //Cutting
            //Thin Casing
                e.recipes.create.cutting('2x nyagibits_bytes:thin_casing',['create:shaft'])
        //Mechanical Crafting
